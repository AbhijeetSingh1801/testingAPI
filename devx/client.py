...
class DevXClient:
    ...
    def _get_orders(self, params: Dict[str, Any]) -> List[Dict]:
    ...
    def _flatten_buyer_address(self, order: Dict, product: Dict) -> Dict:
    ...
    def _flatten_product_attributes(self, product: Dict) -> Dict:
    ...
    def _flatten_product_misc(self, product: Dict) -> Dict:
        misc = product.pop("misc_data", {})
        for key, value in misc.items():
            product[key] = value
        return product

    def _add_order_data(self, product: Dict, order: Dict) -> Dict:
    ...
    def _add_line_item_group(self, product: Dict) -> Dict:
    ...
    def _extract_products(self, orders: List[Dict]) -> pd.DataFrame:
        rows = []
        for order in orders:
    ...
    def extract_orders_data(self, params: Dict[str, Any]) -> pd.DataFrame: 
        orders = self._get_orders(params)
        orders_df = self._extract_products(orders)
        return orders_df
